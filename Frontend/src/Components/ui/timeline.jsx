        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-10 md:gap-10">
            <div
              ...
              <div
                className="h-5 absolute left-3 md:left-5.5 w-5 rounded-full bg-white dark:bg-black flex items-center justify-center">
                <div
                  className="h-4 w-4 rounded-full bg-neutral-200 dark:bg-[#11376e] border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
              {/* <h3
                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-[#11376e] ">
                {item.title}
              </h3> */}
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-[#ffbe00] ">
                {item.title}
              </h3>
            </div>
